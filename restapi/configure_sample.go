...
//go:generate swagger generate server --target ../../go-swagger-example --name Sample --spec ../docs/swagger.yaml --principal interface{}
...
func configureAPI(api *operations.SampleAPI) http.Handler {
	...
	// You may change here the memory limit for this multipart form parser. Below is the default (32 MB).
	// pet.UploadFileMaxParseMemory = 32 << 20
